...
export default function Products() {
  ...
  return (
    <div className="animate-in fade-in duration-500 pb-10 max-w-[1200px]">
      ...
      {products.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-[24px] border border-dashed border-gray-200 text-gray-400 font-sans text-[14px]">
          No matching products found in the database directory.
        </div>
      ) : (
